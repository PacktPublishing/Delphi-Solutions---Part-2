...
type
  ...
  private
    ...
    FSnapshot: TBitmap;
    procedure UpdateGUI;
    function GetResizedBitmap(const Value: TBitmap; const MaxSize: UInt16 = 640): TBitmap;
...
uses System.DateUtils, System.IOUtils, System.SyncObjs, System.StrUtils, System.Math;
...
function TMainForm.GetResizedBitmap(const Value: TBitmap; const MaxSize: UInt16 = 640): TBitmap;
var
  lProp: Extended;
  lLongerSide: Double;
begin
...
begin
  Button1.StyleLookup := IfThen(CameraComponent1.Active,
    'stoptoolbutton', 'playtoolbutton');
end;
