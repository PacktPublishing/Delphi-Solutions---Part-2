  ...
  RESTRequest1.ExecuteAsync(
    ...
    begin
      ...
      begin
        ...
        LTempMin := (LMainForecast.GetValue('temp_min') as TJSONNumber)
          .AsDouble;
        LTempMax := (LMainForecast.GetValue('temp_max') as TJSONNumber)
          .AsDouble;
        ...
        AddForecastItem(ListView1.Items, LForecastDateTime, LWeatherDescription,
          LTempMin, LTempMax);
      end; // for in
...
begin
  ...
  case AItem.Purpose of
    TListItemPurpose.None:
      begin
        AQuarter := (lListView.Width - lListView.ItemSpaces.Left - lListView.ItemSpaces.Right) / 4;
        AItem.Height := 24;
