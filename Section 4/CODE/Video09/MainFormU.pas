...
uses
  ...
  FMX.ActnList, FMX.StdActns, FMX.PhoneDialer.Actions, FMX.Controls.Presentation;
...
begin
  lbInfo.Clear;
  if TPlatformServices.Current.SupportsPlatformService(IFMXPhoneDialerService, IInterface(FPhoneDialerService))
  then
  begin
