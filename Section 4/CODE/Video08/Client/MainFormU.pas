...
uses
  ...
  FMX.Types, FMX.Controls, FMX.Graphics, FMX.Forms, FMX.Dialogs, FMX.TabControl, System.Actions,
  FMX.ActnList,
...
type
  ...
  private
    ...
    property BackgroundOperationRunning: Boolean read FBackgroundOperationRunning
      write SetBackgroundOperationRunning;
  public
    { Public declarations }
  end;
