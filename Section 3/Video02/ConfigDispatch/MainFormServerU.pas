...
uses
  ...
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, IdSocketHandle, IdBaseComponent, IdComponent, IdUDPBase, IdUDPServer,
...
procedure TMainForm.IdUDPServer1UDPRead(AThread: TIdUDPListenerThread; const AData: TIdBytes;
